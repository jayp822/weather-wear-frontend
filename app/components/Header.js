  ...
  return (
    <div className="mx-auto sm:w-[60%] space-y-7 px-1">
      <h1 className="text-center text-balance text-white font-bold text-[1.5rem] sm:text-[2rem] w-[85%] sm:w-[75%] pt-[5rem] mx-auto">
        Hello, Welcome to <span className='text-blue-400 underline decoration-wavy decoration-[2px] text-nowrap '>Weather Wear</span> with just one click you can always be
